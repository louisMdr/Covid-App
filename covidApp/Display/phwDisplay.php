...
<html>
<head>
	<title>C19PHCS - Public Health Worker Info</title>
...
<h2>Public Health Workers information:</h2><br>

<?php
	//TODO: Find out about parents thing!!
	$psns = $db->prepare('SELECT * FROM comp353.publichealthworker WHERE isDeleted = 1');
	$psns->execute();
